...
$_LANG['affiliatesactivate'] = "فعال سازی حساب بازاریابی";
...
$_LANG['clientareafraud'] = "کلاهبرداری";
...
$_LANG['clientareanavdetails'] = "ویرایش حساب کاربری";
...
$_LANG['ordertos'] = "(قوانین و مقررات)";
$_LANG['ordertosagreement'] = "قوانین را مطالعه کردم و مقررات را می پذیرم.";
...
$_LANG['pwdoesnotmatch'] = "رمزعبور وارد شده با رمزعبور قبلی مطابقت ندارد";
...
$_LANG['serverhostname'] = "نام سرور";
$_LANG['serverlogindetails'] = "مشخصات ورودی";
$_LANG['servername'] = "نام سرور";
$_LANG['serverns1prefix'] = "ns1.highhost.org";
$_LANG['serverns2prefix'] = "ns2.highhost.org";
$_LANG['serverpassword'] = "کلمه عبور";
$_LANG['serverrootpw'] = "کلمه عبور سرور";
...
$_LANG['supportticketclosedmsg'] = "این درخواست بسته شده است. جهت بازگشایی آن، باید پاسخی ارسال کنید.";
...
$_LANG['pwresetrequested'] = "درخواست تغییر رمزعبور با موفقیت ارسال شد";
$_LANG['pwresetcheckemail'] = "اگر آدرس ایمیلی که وارد کردید با حساب مورد نظر مطابقت دارد ، لطفاً ایمیل خود را برای راهنمایی در مورد اقدامات بعدی بررسی کنید.";
...
$_LANG['noquotes'] = "در حال حاضر مظنه ای در حساب شما ذخیره نشده است.برای درخواست مظنه درخواست خود را از طریق درخواست ارسال کنید.";
...
$_LANG['navtickets'] = "درخواست ها";
$_LANG['navopenticket'] = "ارسال درخواست پشتیبانی";
...
$_LANG['cpanellogin'] = "ورود به سیپنل";
$_LANG['cpanelwhmlogin'] = "ورود به WHM";
$_LANG['cpanelwebmaillogin'] = "ورود به وبمیل";
...
$_LANG['ticketfeedbacktitle'] = "تقاضای نظر در مورد درخواست";

$_LANG['nosupportdepartments'] = "بخش پشتیبانی ای یافت نشد ، لطفا بعدا تلاش کنید.";

$_LANG['feedbackclosed'] = "بازخورد تا زمان بسته شدن درخواست قابل ارائه نمیباشد.";
$_LANG['feedbackprovided'] = "شما در حال حاضر نظرتان را در مورد این درخواست ارائه داده اید";
$_LANG['feedbackthankyou'] = "از وقتی که برای ارائه نظرتان در مورد این درخواست صرف نمودید سپاسگذاریم";
...
$_LANG['feedbackclickreview'] = "اینجا کلیک کنید تا درخواست را بازبینی کنید";
...
$_LANG['ssounabletologin'] = "در انتقال شما به سرور سیپنل خطایی رخ داده است.";
...
$_LANG['yourtickets'] = "درخواست های شما";
...
$_LANG['ticketfeedbackforticket'] = "برای درخواست #";
...
$_LANG['restrictedpage'] = "وارد حساب کاربری خود شوید";
...
$_LANG['ticketsyourhistory'] = "تاریخچه درخواست شما";
...
$_LANG['ticketinfo'] = "اطلاعات درخواست";
...
$_LANG['yourrecenttickets'] = "درخواست های اخیر شما";
...
$_LANG['clientAlerts']['creditBalance'] = "شما  :creditBalance در حسابتان دارید";

// Client homepage panels
$_LANG['clientHomePanels']['unpaidInvoices'] = "صورت حساب ها";
...
$_LANG['clientHomePanels']['recentSupportTickets'] = "درخواست های اخیر";
$_LANG['clientHomePanels']['recentSupportTicketsNone'] = "هیچ درخواستی یافت نشد. اگر سوالی دارید، درخواست جدید برای ما ارسال کنید.";
$_LANG['clientHomePanels']['affiliateSummary'] = "موجودی کمیسیون فعلی شما :commissionBalance میباشد. شما تنها نیازمند :amountUntilWithdrawalLevel برای برداشت موجودی کمیسیون خود نیاز دارید.";
...
$_LANG['affiliateWithdrawalSummary'] = "هنگامی که موجودی شما به حداقل مقدار :amountForWithdrawalبرسد، میتوانید موجودی خود را برداشت کنید";

$_LANG['projectManagement']['activeProjects'] = "پروژه های فعال شما";

# cPanel Module

$_LANG['cPanel']['packageDomain'] = "پلن/دامنه";
...
$_LANG['cPanel']['forwarders'] = "انتقال دهندگان";
$_LANG['cPanel']['autoresponders'] = "پاسخ دهنده خودکار";
$_LANG['cPanel']['fileManager'] = "مدیریت فایل ها";
$_LANG['cPanel']['backup'] = "بکاپ";
$_LANG['cPanel']['subdomains'] = "زیردامنه";
$_LANG['cPanel']['addonDomains'] = "افزودن دامنه";
$_LANG['cPanel']['cronJobs'] = "کرون جابز";
$_LANG['cPanel']['mysqlDatabases'] = "دیتابیس ها";
$_LANG['cPanel']['phpMyAdmin'] = "مدیریت دیتابیس ها";
$_LANG['cPanel']['awstats'] = "آمار";

$_LANG['cPanel']['createEmailAccount'] = "ساخت سریع ایمیل";
$_LANG['cPanel']['usernamePlaceholder'] = "نام ایمیل";
$_LANG['cPanel']['passwordPlaceholder'] = "رمزعبور";
$_LANG['cPanel']['create'] = "ایجاد";
$_LANG['cPanel']['emailAccountCreateSuccess'] = "حساب ایمیل با موفقیت ساخته شد!";
$_LANG['cPanel']['emailAccountCreateFailed'] = "ساخت حساب ایمیل به دلیل روبرو با شکست مواجه شد: ";

$_LANG['cPanel']['packageNotActive'] = "وضعیت بسته میزبانی وب شما: ";
...
$_LANG['orderForm']['domainAlternativeContact'] = "شما می توانید هنگام ثبت سفارش از طرف شخص یا نهاد دیگری ، اطلاعات تماس ثبت شده جایگزین را برای ثبت دامنه (ها) در سفارش خود تعیین کنید. اگر نیازی به این کار ندارید ، می توانید از این بخش صرف نظر کنید.";
$_LANG['orderForm']['accountSecurity'] = "امنیت حساب کاربری";
...
$_LANG['orderForm']['configureDesiredOptions'] = "گزینه های مورد نظر خود را پیکربندی کرده و سپس به خرید خود ادامه دهید.";
...
$_LANG['orderForm']['submitTicket'] = "ارسال درخواست";
...
$_LANG['orderForm']['continueShopping'] = "ادامه به خرید کردن";
...
$_LANG['orderForm']['includedWithPlans'] = "ویژگی تمام پلن ها:";
...
$_LANG['orderForm']['errorNoGateways'] = "به علت عدم وجود درگاه پرداخت امکان ایجاد سفارش وجود ندارد";
...
$_LANG['sso']['title'] = "ورود اتوماتیک";
$_LANG['sso']['summary'] = "ابزار ورود اتوماتیک به شما کمک می کند تا به راحتی و بدون نیاز به لاگین وارد اکانت های هاست خود شوید.";
$_LANG['sso']['disablenotice'] = "شما می توانید با انتخاب خود این امکان را فعال و یا غیر فعال کنید. مثلا اگر دسترسی هاست خود را به طراح وب سایت و یا برنامه نویسی می دهید، غیر فعال کردن این گزینه می تواند امنیت بیشتری برای اکانت شما به ارمغان بیارود. بدین شکل شخص ثالث امکان ورود اتوماتیک به اکانت های شما را نخواهد داشت.";
...
$_LANG['oauth']['copyrightFooter'] = "کپی رایت &copy; :dateYear :companyName. تمامی حقوق محفوظ است.";
...
$_LANG['orderForm']['extendExclusions'] = "پسوند های خاص و دامنه هایی را که اخیراً تمدید شده اند ، شامل نمی شود";
...
$_LANG['orderForm']['authCodePlaceholder'] = "کد انتقال";
...
$_LANG['pricing']['browseExtByCategory'] = "مشاهده مرور موضوعی پسوند های قابل ثبت";
...
$_LANG['pricingCycleShort']['monthly'] = "ماه";
...
$_LANG['remoteAuthn']['linkInitiated'] = "اصال حساب کاربری آغاز شد!";
...
$_LANG['remoteAuthn']['redirecting'] = "ورود به صورت اتوماتیک با موفقیت انجام شد. در حال انتقال به پنل کاربری...";
...
$_LANG['remoteAuthn']['saveTimeByLinking'] = "با ثبت نام با استفاده از یک حساب موجود در هر یک از خدمات زیر ، در وقت صرفه جویی کنید.";
...
$_LANG['errorPage']['404']['subtitle'] = "ما صفحه ای که درخواست کردید را پیدا نکردیم";
$_LANG['errorPage']['404']['description'] = "لطفا سعی کنید از طریق دکمه های زیر مسیریابی کنید.";
$_LANG['errorPage']['404']['home'] = "صفحه اصلی";
$_LANG['errorPage']['404']['submitTicket'] = "تماس با پشتیبانی";
...
$_LANG['cart']['applyCreditAmount'] = "مقدار <span>:amount</spanتومان از موجودی من را برای این سفارش استفاده کن و بقیه هزینه را از طریق روش های پرداختی، پرداخت خواهم کرد";
$_LANG['cart']['applyCreditAmountNoFurtherPayment'] = "مقدار <span>:amount</span> از موجودی من برای پرداخت این سفارش استفاده کن.";
$_LANG['cart']['applyCreditSkip'] = "از موجودی من جهت پرداخت این سفارش استفاده نکن. این سفارش را از طریق روش های پرداختی، پرداخت خواهم کرد.";
...
$_LANG['sslState']['sslInactiveService'] = "سرویس غیرفعال میباشد";
$_LANG['sslState']['sslInactiveDomain'] = "دامنه غیرفعال میباشد";
...
$_LANG['generatePassword']['btnLabel'] = "ساخت رمزعبور";
$_LANG['generatePassword']['btnShort'] = "ساخت";
$_LANG['generatePassword']['title'] = "ساخت رمزعبور";
$_LANG['generatePassword']['lengthValidationError'] = "لطفا یک عدد بین 8 تا 64 برای طول رمزعبور انتخاب کنید";
$_LANG['generatePassword']['pwLength'] = "طول رمزعبور:";
$_LANG['generatePassword']['generatedPw'] = "رمزعبور ساخته شده:";
$_LANG['generatePassword']['generateNew'] = "ساخت رمز جدید";
$_LANG['generatePassword']['copyAndInsert'] = "کپی رمز و وارد کردن";
...
$_LANG['support']['attachmentsRemoved'] = "به علت عدم فعالیت درخواست، درخواست مورد نظر بسته شد";
$_LANG['unpaidInvoiceAlert'] = "شما یک فاکتور پرداخت نشده برای این سرویس دارید. جهت جلوگیری از بسته شدن سرویس خود آن را پرداخت کنید.";
$_LANG['overdueInvoiceAlert'] = "شما یک فاکتور پرداخت نشده دارید.";
...
$_LANG['copyrightFooterNotice'] = "کپی رایت &copy; :year :company. تمامی حقوق محفوظ است.";
$_LANG['copyrightFooterNotice'] = "تمامی حقوق برای :company تا سال :year محفوظ است.";
...
$_LANG['support']['ccRecipients'] = "ارسال کپی";
$_LANG['support']['addCcRecipients'] = "آدرس ایمیل";
$_LANG['support']['removeRecipient'] = "حذف مشترک";
...
$_LANG['emailPreferences']['affiliate'] = "ایمیل های بازاریابی - تعداد کلیک ها و گزارش های ماهانه";
$_LANG['emailPreferences']['domain'] = "ایمیل های دامنه - اطلاعات بروز شده، تائیدات ثبت نام ها و غیره...";
$_LANG['emailPreferences']['general'] = "ایمیل های کلی - اعلانات کلی و یاد آوری های کلمه عبور";
$_LANG['emailPreferences']['invoice'] = "ایمیل های صورتحساب - یاد آوریهای صورتحساب ها";
$_LANG['emailPreferences']['product'] = "ایمیل های محصول-جزئیات سفارش ،ایمیل خوش آمدگویی و غیره...";
$_LANG['emailPreferences']['support'] = "ایمیل های پشتیبان - اعلانات درخواست های پشتیبانی";
...
$_LANG['navContacts'] = "مدیریت مخاطبین";
$_LANG['navUserManagement'] = "مدیریت کاربران";
$_LANG['navSwitchAccount'] = "تغییر حساب کاربری";
$_LANG['navAccountSecurity'] = "ورود اتوماتیک";

$_LANG['never'] = "Never";

$_LANG['yourProfile'] = "حساب کاربری من";
...
$_LANG['switchAccount']['title'] = "انتخاب حساب کاربری";
$_LANG['switchAccount']['choose'] = "حسابی که قصد ورود و مدیریت آن را دارید را انتخاب کنید.";
$_LANG['switchAccount']['noneFound'] = "هیچ حساب کاربری یافت نشد.";
...
$_LANG['clientOwner'] = "مالک اصلی";

$_LANG['userManagement']['title'] = "مدیریت کاربران حساب";
$_LANG['userManagement']['managePermissions'] = "مدیریت دسترسی ها";
$_LANG['userManagement']['permissions'] = "دسترسی ها";
$_LANG['userManagement']['usersFound'] = ":count کاربر دارید";
...
$_LANG['userManagement']['pendingInvites'] = "دعوت های معلق";
...
$_LANG['userManagement']['accountOwnerPermissionsInfo'] = "مالک اصلی همیشه به تمامی بخش ها و امکانات دسترسی کامل دارد.";
...
$_LANG['smpaypal']['descriptor'] = "در این بخش شما میتوانید با وارد کردن کد تراکنش پیپال خود، فاکتور خود را پرداخت کنید.";
$_LANG['smpaypal']['success'] = 'تراکنش شما با موفقیت پرداخت شد';
$_LANG['smpaypal']['transactionID'] = 'کد تراکنش واریزی';
$_LANG['smpaypal']['registerTransaction'] = "بررسی تراکنش";
$_LANG['smpaypal']['invoiceTitle'] = "فاکتور";
$_LANG['smpaypal']['pageTitle'] ="پرداخت صورتحساب ";
$_LANG['smpaypal']['submitTransaction'] ="ثبت اطلاعات تراکنش پیپال";
$_LANG['smpaypal']['sendPaymentTo'] ="مبلغ موجود در این فاکتور را به آدرس ایمیل زیر از طریق پیپال ارسال نمایید.";
$_LANG['smpaypal']['accessDenied'] = "شما دسترسی لازم جهت مشاهده این فاکتور را ندارید.";
$_LANG['smpaypal']['invalidInvoice'] = "مشخصات فاکتور درخواستی معتبر نمیباشد.";
$_LANG['smpaypal']['notUnpaidInvoice'] = "فاکتور درخواست شده، در وضعیت پرداخت نشده نمیباشد.";
$_LANG['smpaypal']['getTokenError'] = "خطایی درارتباط با سرور پیپال رخ داده است. بعدا مجدد سعی کنید.";
$_LANG['smpaypal']['getTransactionError'] = "دریافت اطلاعات تراکنش با خطا مواجه شده است. این مورد را از طریق بخش پشتیبانی اطلاع دهید.";
$_LANG['smpaypal']['transactionNotFound'] = "کد تراکنش مورد نظر یافت نشد. این مورد را از طریق پشتیبانی اطلاع دهید.";
$_LANG['smpaypal']['transactionNotCompeleted'] = "تراکنش مورد نظر در وضعیت کامل و تایید شده نمیباشد.";
$_LANG['smpaypal']['repeatedTransaction'] = "کد تراکنش وارد شده قبلا استفاده شده است.";
$_LANG['smpaypal']['transactionAmountNotMatch'] = "مقدار تراکنش با مقدار فاکتور برابر نمیباشد. جهت اعمال مقدار تراکنش به صورت دستی از طریق پشتیبانی در ارتباط باشید.";
